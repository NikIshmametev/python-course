...
def setup_logging(logging_yaml_config_fpath):
    ...
    if logging_yaml_config_fpath:
        ...
        handler_debug = logging.FileHandler(filename='asset_log.debug')
        handler_debug.setLevel(logging.DEBUG)
        handler_debug.setFormatter(formatter)

        handler_warn = logging.FileHandler(filename='asset_log.warn')
        handler_warn.setLevel(logging.WARN)
        handler_warn.setFormatter(formatter)

        logger.setLevel(logging.DEBUG)
        for handler in [handler_debug, handler_warn, handler_stream]:
